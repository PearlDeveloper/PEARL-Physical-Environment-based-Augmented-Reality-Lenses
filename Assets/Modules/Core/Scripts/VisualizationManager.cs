...
namespace IMLD.MixedRealityAnalysis.Core
{
    ...
    public class VisualizationManager : MonoBehaviour
    {
        ...
        public bool fbToggleAnimationPlay = false;

        ViewTimelineControl timelineControl;
        ...
        public GameObject CreateTimelineControl(VisProperties settings)
        {
            ...
            GameObject vis;
            timelineControl = Instantiate(TimelineControlPrefab);
            timelineControl.GetComponent<PhotonView>().ViewID = viewIDStart;
            viewIDStart++;
        ...
        {
            //Debug.Log("running");
            if (fbToggleAnimationPlay)
            {
                fbToggleAnimationPlay = false;
                timelineControl.TogglePlayback();
            }
        }
    }
}